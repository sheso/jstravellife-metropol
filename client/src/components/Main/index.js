      ...
      <div className={style.conteiner}>
        ...
        <div className={style.centerBtn}>
          ...
          <div className={style.booking}>
            <a className={style.linkBooking} href="https://be.synxis.com/?_ga=2.208427482.957974354.1616845732-1432913282.1615819046&adult=1&arrive=2021-03-28&chain=21125&child=0&currency=RUB&depart=2021-03-29&hotel=3819&level=hotel&locale=ru-RU&rooms=1">
              {" "}
              {statusLang.translate
